...
A parte frontal da estrutura comporta a roda dianteira da bicicleta e é responsável pela elevação e descida da plataforma dando a sensação de um terreno com variação de altura para que o usuário tenha uma experiência mais imersiva ao ambiente virtual.
    ...
    \begin{center}
    	\includegraphics[scale=0.7]{figuras/partedafrente.png}
...
­
    ...
    %Figura 7: Stress equivalente com Tensão de escoamento da peça 1.
    ...
    %Figura 12: Simulação estática estrutural da peça 2 – Tensão elástica equivalente
 
    %Figura 13: Stress equivalente com Tensão de escoamento da peça 2
 
    %Figura 14: Modal de corpo livre - Deformação total para a peça 2.
 
    %Figura 15: Fator de segurança da peça 2
 
    %Figura 16: Vida útil da peça 2
 
    %Figura 17: Módulos de vibração de ressonância da peça 2.
...
\subsection{Alternador}
    ...
    %Figura 12: CAD do alternador com a correia acoplada na coroa
