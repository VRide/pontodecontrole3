...
\subsection{Integração Parte Dianteira}
  ...
  \begin{itemize}
    ...
    \begin{center}
        ...
        \captionof{figure}{Base dianteira}
        \label{base.dianteira}
    \end{center}  

	Na Figura \ref{base.dianteira} é mostrado a estrutura feita para dar maior estabilidade em um sistema que tem subidas e descidas. Ainda foi aproveitado essa estrutura para atender ao requisito pedido pelos professores de criar uma resistência ao girar o guidão. A solução foi fazer alguns pontos para fixar algumas molas que serão fixadas na mesa giratória, aumentando conforme o giro no guidão.
	
	    \begin{center}
    	\includegraphics[scale=0.5]{figuras/Base_dianteira_macaco}
        \captionof{figure}{Base dianteira com o macaco integrado}
        \label{base.dianteira.macaco}
    \end{center}  
    
    A sequência apresentada na figura acima apresenta a integração entre a base e o macaco com parafusos. Há ainda visível uma estrutura soldada em cima do macaco para facilitar a integração com a mesa giratória, apresentada na imagem abaixo.
    
    	    \begin{center}
    	\includegraphics[scale=0.5]{figuras/Base_dianteira_macaco_mesagiratoria}
        \captionof{figure}{Parte dianteria completa}
        \label{base.dianteira.macaco.giratoria}
    \end{center}  

	Assim é possível parafusar a mesa giratória no macaco, integrando os sistemas da parte frontal. Alguns detalhes particulares da integração com outras áreas serão apresentadas na sessão \ref{secao.integracao}. Abaixo vê-se a foto real da parte dianteira para comparação.
