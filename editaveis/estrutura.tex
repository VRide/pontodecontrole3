...
\subsection{Freio controlado} 
    ...
    \begin{center}
    	\includegraphics[scale=0.7]{figuras/freio_moto}
    ...
    \begin{center}
    	\includegraphics[scale=0.7]{figuras/freio_pendulo}
    ...
    \begin{center}
    	\includegraphics[scale=0.7]{figuras/carga_peso}
    ...
    \begin{center}
    	\includegraphics[scale=0.7]{figuras/sim_est_freio}
