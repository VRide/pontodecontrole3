...
O esquema da figura \ref{sensores} mostra a topologia do sistema de aquisição de dados da bicicleta.  Como ilustrado, o Raspberry  concentra os dados, faz alguns processamentos(Linha x do Anexo X), envia os dados para o PC,  e também deve utilizá-los como parâmetro de entrada para sistema de controle.  
            \begin{center}
...
A intensidade de frenagem foi obtida capturando a força que a borracha de freio aplica no aro da bicicleta. Foi utilizado um sensor FSR(Figura X) com o circuito de instrumentação mostrado abaixo.
